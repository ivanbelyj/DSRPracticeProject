namespace DSRPracticeProject.Common;
...
using DSRPracticeProject.Common.JsonConverters;

public static class ObjectJsonExtension
{
    public static JsonSerializerSettings SetDefaultSettings(
    ...
    public static bool TryDeserializeFromJsonString<T>(this string obj,
        out T? result)
    {
        try
        {
